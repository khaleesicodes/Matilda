...
public abstract class MatildaFileSystemProvider extends FileSystemProvider {
   ...
   */
  public MatildaFileSystemProvider(String scheme, FileSystem delegateInstance) {
    this.scheme = Objects.requireNonNull(scheme);
    Objects.requireNonNull(delegateInstance);
    this.delegate = delegateInstance.provider();
    this.fileSystem = new MatildaFileSystem(this, delegateInstance);
  }
   ...
   */
  public MatildaFileSystemProvider(String scheme, FileSystemProvider delegate) {
    this.scheme = Objects.requireNonNull(scheme);
